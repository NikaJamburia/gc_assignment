    ...
    private final Thread backgroundStatisticsCleaningThread = new Thread(() -> {
        while (true) {
            ...
            try {
                ...
                // ბოლოს მივხვდი რომ ეს მთლად ეფექტური არაა, რადგან გაღვიძების მერე ეს ტრედი კონკურენციაში შევა ექზეკიუტორის ტრედთან,
                // და შეიძლება ვერ მოასწროს დალოქვა, რის გამოც ლისტები შიეძლება ვერ გაიწმინდოს თავის დროზე. მგონი დიდი პრობლემა არაა და
                // დამატებითი ქონდიშენითაც შეიძლება მოგვარება, ან რამე ფლეგით
